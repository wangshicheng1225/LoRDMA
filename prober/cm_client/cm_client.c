...
static const char *server = "192.168.3.136";
static const char *port = "7471";
static const char *client_addr = "192.168.3.135";
...
static int run(void)
{
	...
	src_addr.sin_port = htons(1514); 
	inet_pton(AF_INET, client_addr, &(src_addr.sin_addr)); 

	hints.ai_src_addr = (struct sockaddr *)&src_addr;
	hints.ai_src_len = sizeof src_addr;
