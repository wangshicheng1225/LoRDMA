	...
	*/
	...
	protected:
		...
		*/
		...
		//file stream
		std::ofstream m_datarate_file;
		std::ofstream m_qlen_file;
		std::ofstream m_rtt_file;
		std::ofstream m_ack_file;
		std::ofstream m_probe_file;
		std::ofstream m_ecmp_file;
		std::ofstream m_congestion_file;
		std::ofstream m_portrate_file;

		double m_last_datarate_time;
		double m_EPS;
		double m_last_portrate_time;
		double m_last_qlen_time;
		double m_qlen_EPS;

		std::string m_datarate_path;
		std::string m_qlen_path;
		std::string m_rtt_path;
		std::string m_ack_path;
		std::string m_probe_path;
		std::string m_ecmp_path;
		std::string m_congestion_path;
		std::string m_portrate_path;
		uint32_t m_total_nic_num;

		bool m_pfc_pause_status;
	};
